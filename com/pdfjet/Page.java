...
final public class Page {
     ...
     * vertical scale.
     *
     * @param values the scale x, skew x, translate x, skew y, scale y and translate y
     *        at the MSCALE_X to MTRANS_Y indices, the first six values of an Android
    ...
    public void transform(float[] values) {
        ...
        // The y coordinates are computed from the page height, so it is scaled too.
