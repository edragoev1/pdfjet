...
// HelveticaBoldOblique returns the core font.
func HelveticaBoldOblique() *CoreFont {
    font := new(CoreFont)
    font.Name = "Helvetica-BoldOblique"
    font.Notice = "Copyright (c) 1985, 1987, 1989, 1990, 1997 Adobe Systems Incorporated. All Rights Reserved. Helvetica is a trademark of Linotype-Hell AG and/or its subsidiaries."
    font.BBoxLLx = -174
    font.BBoxLLy = -228
    font.BBoxURx = 1114
    font.BBoxURy = 962
    ...
    font.Metrics = getHelveticaBoldObliqueMetrics()
    return font
}

func getHelveticaBoldObliqueMetrics() [][]int {
    return [][]int{
