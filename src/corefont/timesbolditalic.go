...
// TimesBoldItalic returns the core font.
func TimesBoldItalic() *CoreFont {
    font := new(CoreFont)
    font.Name = "Times-BoldItalic"
    font.Notice = "Copyright (c) 1985, 1987, 1989, 1990, 1993, 1997 Adobe Systems Incorporated. All Rights Reserved. Times is a trademark of Linotype-Hell AG and/or its subsidiaries."
    font.BBoxLLx = -200
    font.BBoxLLy = -218
    font.BBoxURx = 996
    font.BBoxURy = 921
    ...
    font.Metrics = getTimesBoldItalicMetrics()

    return font
}

func getTimesBoldItalicMetrics() [][]int {
    return [][]int{
