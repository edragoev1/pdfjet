...
func Example27() {
	...
	textLine.SetLocation(600.0-f3.StringWidth(f2, f2.GetSize(), str), y)
	...
	str = pdfjet.ReorderVisually(str)
	textLine = pdfjet.NewTextLine(f2, str)
	textLine.SetLocation(600.0-f2.StringWidth(f2, f3.GetSize(), str), y)
	textLine.DrawOn(page)
	...
	str = pdfjet.ReorderVisually(str)
	textLine = pdfjet.NewTextLine(f2, str)
	textLine.SetLocation(600.0-f2.StringWidth(f2, f2.GetSize(), str), y)
	textLine.DrawOn(page)
	...
	textLine.SetLocation(600.0-f3.StringWidth(f3, f3.GetSize(), str), y)
	textLine.DrawOn(page)
