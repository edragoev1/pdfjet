...
// type, written to the document as a PDF form XObject by Complete, and
// placed on pages with DrawOn, at a location, a rotation and a scale, as a
// Container is.
//
...
// watermark wants.
//
// What it costs: a stamp draws with the methods of this type -- MoveTo,
