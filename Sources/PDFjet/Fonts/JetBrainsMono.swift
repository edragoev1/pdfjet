...
///
/// The JetBrains Mono fonts. Each constant is the path of a font file in the
/// .ttf.stream format; pass it to the Font constructor that takes a font path.
///
public struct JetBrainsMono {
    /// JetBrains Mono Bold
    ...
    public static let Light            = "fonts/JetBrainsMono/JetBrainsMono-Light.ttf.stream"
    /// JetBrains Mono Light Italic
    public static let LightItalic      = "fonts/JetBrainsMono/JetBrainsMono-LightItalic.ttf.stream"
    /// JetBrains Mono Medium
    public static let Medium           = "fonts/JetBrainsMono/JetBrainsMono-Medium.ttf.stream"
    /// JetBrains Mono Medium Italic
    public static let MediumItalic     = "fonts/JetBrainsMono/JetBrainsMono-MediumItalic.ttf.stream"
    /// JetBrains Mono Regular
    public static let Regular          = "fonts/JetBrainsMono/JetBrainsMono-Regular.ttf.stream"
