...
class RSBlock {
    ...
    static func getRSBlocks(
        ...
        let rsBlock = RS_BLOCK_TABLE[(typeNumber - 1) * 4 + getTableIndex(errorCorrectionLevel)]
    ...
    // The raw value of a level is its format information bits; the table is
    // in the order L, M, Q, H.
    private static func getTableIndex(_ errorCorrectionLevel: ErrorCorrectionLevel) -> Int {
