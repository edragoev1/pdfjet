...
- ⬜ **B** Goal 5: the reader against the pdf.js and veraPDF corpora, which
      ...
      committed, as their copyright is many people's -- and
      `tests/corpus/check-corpus.py` reads, merges and splits the first and
      the last page of each, and compares the page count, the page sizes and
